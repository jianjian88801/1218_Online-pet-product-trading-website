<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="适用宠物" prop="shiyongchongwu">
          <el-select v-model="ruleForm.shiyongchongwu" placeholder="请选择适用宠物">
            <el-option
                v-for="(item,index) in shiyongchongwuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.shiyongchongwuOptions = "宠物狗,宠物猫,宠物鼠,宠物兔,通用".split(',')
            this.$http({
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../springbootqi5z1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
